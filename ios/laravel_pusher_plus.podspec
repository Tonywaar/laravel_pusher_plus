...
# Run `pod lib lint laravel_pusher_plus.podspec` to validate before publishing.
#
...
Pusher client that supports laravel echo
  ...
  s.prepare_command = <<-CMD
    ...
    echo "#define LIBRARY_NAME @\\"laravel_pusher_plus\\"" >> Classes/UserAgent.h
