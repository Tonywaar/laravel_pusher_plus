package dev.tonywaar.laravel_pusher_plus;

import android.util.Log;

import androidx.annotation.NonNull;

import dev.tonywaar.laravel_pusher_plus.platform_messages.InstanceMessage;
...
/**
 * LaravelPusherPlusPlugin
 */
public class LaravelPusherPlusPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public LaravelPusherPlusPlugin() {
    }


    @Override
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        channel = new MethodChannel(binding.getBinaryMessenger(), "dev.tonywaar/pusher");
        eventStream = new EventChannel(binding.getBinaryMessenger(), "dev.tonywaar/pusherStream");

        channel.setMethodCallHandler(new LaravelPusherPlusPlugin());
        eventStream.setStreamHandler(new EventChannel.StreamHandler() {
            ...
            public void onListen(Object args, final EventChannel.EventSink eventSink) {
                LaravelPusherPlusPlugin.eventSink = eventSink;
            }
